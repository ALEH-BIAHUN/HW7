...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Введите количество иградиентов, которые у Вас есть:");
        ...
        System.out.println("Сколько у Вас кости ворона?:");
        ...
        if (!isCanCook) {
            System.out.println(" У Вас недостаточно инградиентов ни на один эликсир");
        }
    }
}